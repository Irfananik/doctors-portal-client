...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://aqueous-dawn-81823.herokuapp.com/services').then(response => response.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://aqueous-dawn-81823.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
